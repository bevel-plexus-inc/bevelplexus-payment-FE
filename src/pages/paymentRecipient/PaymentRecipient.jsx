      ...
      <Layout currentMenu='payment' payProgress='1' showTips={showTips}>
        ...
        <div className='section-one'>
          ...
          <div className='box-container'>
            ...
            >
              <img src={`${base}assets/svg/recipient.svg`} alt='recipient' />
              <p>To Individual</p>
            </div>
            <div
              className={
            ...
            >
              <img src={`${base}assets/svg/school.svg`} alt='school' />
              <p>Tuition Payment</p>
            </div>
          </div>
        </div>
        ...
        <div className='section-two'>
          ...
          <div className='box-container'>
            <div className='shadow-box'>
              <img src={`${base}assets/svg/contact.svg`} alt='contact' />
              <Select
                showSearch
                style={{ width: 200 }}
              ...
              >
                {allRecipients.map((recipient) => (
                  ...
                  >
                    {recipient.name}
                    <img src={`${base}assets/svg/green-check-alt.svg`} alt='check' />
                  </Option>
                ))}
              </Select>
            </div>
              ...
              <div className='shadow-box'>
                ...
                <div className='contact-details'>
                  ...
                  {transactionType === "Individual" ? (
                    ...
                    <React.Fragment>
                      <p>
                        <img src={`${base}assets/svg/student.svg`} alt='world' />
                        2.512
                      </p>
                      ...
                      <p>
                        <img src={`${base}assets/svg/location.svg`} alt='world' />
